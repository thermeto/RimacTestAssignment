model Rimac_snakeHEX
  ...
  parameter Real massFlowrate = 0.25 "kg/s";
  ...
  parameter Coldplate cp1(length = 0.36, height = 0.010, width = 0.063);
  parameter Coldplate cp2(length = 0.36, height = 0.010, width = 0.063);
  parameter Coldplate cp3(length = 0.36, height = 0.010, width = 0.063);
  ...
  parameter Real Rth_total = 0 + Rth_alWall;
  /*<<<<<<<<----------Boundary conditions and parts properties*/
  ...
  parameter Real cp1HTC = 16.9 "Attention!!! W/K; this value must correspond to cp1HTC_info";
  parameter Real cp2HTC = 16.9 "Attention!!! W/K; this value must correspond to cp2HTC_info";
  parameter Real cp3HTC = 16.9 "Attention!!! W/K; this value must correspond to cp3HTC_info";
  /*****<<<<<<<<--------Coldplate HTC calculation ***********/
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary1(redeclare package Medium = Medium, nPorts = 1, p = 100000) annotation(
    Placement(visible = true, transformation(origin = {288, -106}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Modelica.Fluid.Pipes.StaticPipe staticPipe(redeclare package Medium = Medium, allowFlowReversal = true, diameter = collector.diameter, length = collector.length) annotation(
    Placement(visible = true, transformation(origin = {222, -106}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  ...
  Modelica.Fluid.Pipes.StaticPipe pipe3(redeclare package Medium = Medium, allowFlowReversal = true, diameter = collector.diameter, length = collector.length)  annotation(
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe6(redeclare package Medium = Medium, allowFlowReversal = true, crossArea = cp2.height * cp2.width, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, isCircular = false, length = cp2.length, perimeter = (cp2.width + cp2.height)*2, use_HeatTransfer = true) annotation(
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe7(redeclare package Medium = Medium, allowFlowReversal = true, crossArea = cp3.height*cp3.width, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, isCircular = false, length = cp3.length, perimeter = (cp3.width+cp3.height)*2, use_HeatTransfer = true) annotation(
...
equation
  ...
  connect(teeJunctionIdeal1.port_1, staticPipe.port_a) annotation(
    Line(points = {{176, -106}, {212, -106}}, color = {0, 127, 255}));
  connect(staticPipe.port_b, boundary1.ports[1]) annotation(
    Line(points = {{232, -106}, {278, -106}}, color = {0, 127, 255}));
  annotation(
